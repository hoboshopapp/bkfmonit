...
class CreateSystemsTempRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('systems_temp_records', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('systems_temp_records');
    }
}
